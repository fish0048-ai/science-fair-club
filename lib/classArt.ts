...
const CATALOG: ArtEntry[] = [
  {
    ...
    keywords: ["科展", "評審", "賽制", "全國", "科別", "海報", "優勝", "展示及表達", "總綱"],
  },
  {
    src: "/class/inquiry.jpg",
    alt: "從觀察校園現象提出可檢驗的問題",
    keywords: ["問題", "探究", "觀察", "好奇", "假設", "五條件", "推論", "定題", "好問題", "選題", "漏斗", "題型", "甄選"],
  },
  {
  ...
  },
  {
    ...
    alt: "測量工具、碼錶與安全護目鏡",
    keywords: ["測量", "誤差", "精度", "單位", "安全", "護目", "碼錶", "尺", "紅燈"],
  },
  {
    src: "/class/journal.jpg",
    alt: "成冊研究日誌與誠實紀錄",
    keywords: ["日誌", "倫理", "引用", "APA", "抄襲", "契約", "手寫", "文獻引用", "學習單"],
  },
  {
